    ...
    if (_formKey.currentState!.validate()) {
      ...
      showDialog(
        ...
        builder: (ctx) => AlertDialog(
          title: Text(AppLocalizations.of(context).translate('order_placed')),
          content: Text(AppLocalizations.of(context).translate('order_success')),
          actions: [
            TextButton(
              onPressed: () {
                    ...
                    Column(
                      children: [
                        ...
                        TextFormField(
                          ...
                          validator: _paymentMethod == 'credit'
                              ? (value) {
                                  if (value == null || value.isEmpty) {
                                    return localizations.translate('required_field');
                                  }
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        cartProvider.totalAmount > 500 ? localizations.translate('free') : '15.00 ${localizations.isArabic ? 'ريال' : 'SAR'}',
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
